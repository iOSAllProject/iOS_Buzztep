...
NSString * const valueY = @"yValueFromTop";
NSString * const selectedObject = @"selectedObject";
NSString * const toolbarBackgroundImage = @"toolbarBackgroundImage";
NSString * const textAlignment = @"textAlignment";
NSString * const showsSelectionIndicator = @"showsSelectionIndicator";
...
-(void)dismiss{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"PressedDismiss"
                                                        object:Nil];
}
...
-(void)initializePickerViewInView: (UIView *)view
  ...
  _pickerViewTextAlignment = [options[textAlignment] integerValue];
  }
  
  BOOL showSelectionIndicator = [options[showsSelectionIndicator] boolValue];
  ...
  _yValueFromTop = [options[valueY] floatValue];
...
- (UIView *)pickerView:(UIPickerView *)pickerView
  ...
  if (customPickerView==nil) {
    ...
    CGRect labelFrame = CGRectMake(0.0, _yValueFromTop, 292.0, 35);

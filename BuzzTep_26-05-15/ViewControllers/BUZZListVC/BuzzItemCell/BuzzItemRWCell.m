...
@implementation BuzzItemRWCell

- (void)awakeFromNib {
    // Initialization code

    [self.featureView setFrame:CGRectMake(0, 0, 80, 80)];
    
    [self.lockButton setFrame:CGRectMake(90, 0, 80, 80)];
    [self.mediaView setFrame:CGRectMake(90, 0, 80, 80)];
    
    [self.unlockButton setFrame:CGRectMake(180, 0, 80, 80)];
    ...
    [self.scrollView setContentSize:CGSizeMake(270, 80)];
